  ...
  extends TypeBase
{
  ...
  public SimpleType withStaticTyping()
  {
    ...
    return new SimpleType(this._class, this._typeNames, this._typeParameters, this._valueHandler, this._typeHandler, true, this._typeParametersFor);
  }
  ...
  public SimpleType withValueHandler(Object paramObject)
  {
    ...
    return new SimpleType(this._class, this._typeNames, this._typeParameters, paramObject, this._typeHandler, this._asStatic, this._typeParametersFor);
  }
}


/* Location:              /Users/michael/Downloads/dex2jar-2.0/GO_JEK.jar!/com/fasterxml/jackson/databind/type/SimpleType.class
