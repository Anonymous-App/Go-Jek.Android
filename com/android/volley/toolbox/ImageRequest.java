  ...
  extends Request<Bitmap>
{
  ...
  private Response<Bitmap> doParse(NetworkResponse paramNetworkResponse)
  {
    ...
    if ((this.mMaxWidth == 0) && (this.mMaxHeight == 0))
    {
      ...
      localObject1 = BitmapFactoryInstrumentation.decodeByteArray((byte[])localObject1, 0, localObject1.length, (BitmapFactory.Options)localObject2);
    }
    while (localObject1 == null)
    {
      return Response.error(new ParseError(paramNetworkResponse));
      ((BitmapFactory.Options)localObject2).inJustDecodeBounds = true;
      BitmapFactoryInstrumentation.decodeByteArray((byte[])localObject1, 0, localObject1.length, (BitmapFactory.Options)localObject2);
...
/* Location:              /Users/michael/Downloads/dex2jar-2.0/GO_JEK.jar!/com/android/volley/toolbox/ImageRequest.class
