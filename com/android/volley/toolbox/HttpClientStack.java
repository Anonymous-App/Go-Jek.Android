  ...
  implements HttpStack
{
    ...
    throws IOException, AuthFailureError
  {
    ...
    paramRequest = this.mClient;
    if (!(paramRequest instanceof HttpClient)) {
      return paramRequest.execute(localHttpUriRequest);
    }
    return HttpInstrumentation.execute((HttpClient)paramRequest, localHttpUriRequest);
  }
...
/* Location:              /Users/michael/Downloads/dex2jar-2.0/GO_JEK.jar!/com/android/volley/toolbox/HttpClientStack.class
