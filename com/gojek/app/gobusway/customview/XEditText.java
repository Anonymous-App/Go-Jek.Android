...
import com.gojek.app.gobusway.R.color;
import com.gojek.app.gobusway.R.styleable;
  ...
  extends EditText
{
  ...
  private void init()
  {
    ...
    for (;;)
    {
      ...
      setHintTextColor(getContext().getResources().getColor(R.color.gojek_text_gray));
      return;
      switch (j)
      {
      default: 
...
/* Location:              /Users/michael/Downloads/dex2jar-2.0/GO_JEK.jar!/com/gojek/app/gobusway/customview/XEditText.class
